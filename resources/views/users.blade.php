...
@section('content')
    <div class="overlap">
        <div class="mijnSlider">
            ...
            <p class="center">
                Salve Mundi heeft verschillende commissies die ieder verantwoordelijk zijn voor het functioneren van de
                vereniging.<br> Elke commissie heeft zijn eigen taken en verantwoordelijkheden, en samen zorgen zij ervoor
                dat Salve Mundi kan zijn zoals het is!
            </p>
            <br>
                                ...
                                <div class="col-md-12 d-flex justify-content-between align-items-center">
                                    <div style="">
                                        <p class="card-text">{{ $groupsBestuur->Description }}
                                            <br>
                                            E-mail: <a href="mailto:{{ $groupsBestuur->email }}">{{ $groupsBestuur->email }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                                        <div style="">
                                            <p class="card-text">
                                                ...
                                                <br>
                                                E-mail: <a
                                                    href="mailto:{{ $kandiBestuur->email }}">{{ $kandiBestuur->email }}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12" id="{{ $group->DisplayName }}">
                            <div class="card commissie">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">E-mail: <a
                                            href="mailto:{{ $group->email }}">{{ $group->email }}</a></p>
                                </div>
                            </div>
                        </div>
                </div>
