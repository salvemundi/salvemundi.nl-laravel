...
@section('content')
    ...
    <div class="overlap">
        <div class="container">
            ...
            @foreach ($activiteiten as $activiteit)
                <!-- Modal -->
                <div class="modal fade" id="showModal{{ $activiteit->id }}" tabindex="583208700" style="z-index: 534324;"
                                                ...
                                                @if (App\Http\Controllers\ActivitiesController::userHasPayedForActivity($activiteit->id))
                                                    @if ($activiteit->oneTimeOrder)
                                                        <button class="btn btn-success disabled"><i
                                                                class="fas fa-check"></i> Ingeschreven</button>
                                                    @else
                                                        @if ($activiteit->isGroupSignup)
                                                            <form method="POST" action="/activiteiten/signup">
                                                                ...
                                                                <select class="form-select" id="association"
                                                                    name="association" aria-label="Default select example">
                                            ...
                                            @else
                                                ...
                                                @else
                                                    ...
                                                    <div class="collapse mt-3"
                                                        id="collapseExample-{{ $activiteit->id }}">
                                                        <div class="card card-body">
                                                            <form method="POST" action="/activiteiten/signup">
                                                                @csrf
                                                                @if ($activiteit->isGroupSignup)
                                                                    <input type="hidden" name="activityId"
                                                                        id="activityId" value="{{ $activiteit->id }}">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <div class="input-group mb-3 me-4">
                                                                        <span class="input-group-text"
                                                                            id="basic-addon3">Naam</span>
                                                                        <input required type="text"
                                                                            class="form-control" id="nameActivity"
                                                                            name="nameActivity"
                                                                            aria-describedby="basic-addon3">
                                                                        <br>
                                                                    </div>
