                        ...
                        <tbody>
                            @foreach ($userStickers as $sticker)
                                <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                                    ...
                                    <td data-value="{{ $sticker->id }}">
                                        <form method="post" action="/stickers/delete">@csrf<input type="hidden" name="id"
                                                id="id" value="{{ $sticker->id }}"><button type="submit"
                                                class="btn btn-danger"
                                                onclick="return confirm('Weet je zeker dat je deze sticker wilt verwijderen? Dit kan NIET ongedaan gemaakt worden');">Verwijderen</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <form action="stickers/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control{{ $errors->has('latitude') ? ' is-invalid' : '' }}"
                            value="{{ old('latitude') }}" id="latitude" name="latitude" placeholder="Latitude...">
                    </div>

                    <div class="form-group">
                        <label for="longitude">Longitude*</label>
                        <input class="form-control{{ $errors->has('longitude') ? ' is-invalid' : '' }}"
                            value="{{ old('longitude') }}" id="longitude" name="longitude" placeholder="Longitude...">
                    </div>
