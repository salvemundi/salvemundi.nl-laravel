        ...
        <div class="row">
            <div class="col-12 col-md-6 px-1 px-md-5">
                ...
                <p class="center">
                    ...
                    vereniging.<br> Elke commissie heeft zijn eigen taken en verantwoordelijkheden, en samen zorgen zij
                    ervoor dat Salve Mundi kan zijn zoals het is!
                </p>
            </div>
            <div class="col-12 col-md-6 px-1 px-md-5">
                <img class="imgIndex"
                ...
                <a href="/commissies/{{ $bestuur->DisplayName }}">
                    <div class="card">
                        <img class="card-img-top"
                            src={{ '/' . Thumbnailer::generate('storage/committees/b16d93c7-42ef-412e-afb3-f6cbe487d0e0.png', '1296x864') }}
                            alt="Card image cap">
                        <div class="card-body">
