...
@section('content')
    <div class="row widthFix adminOverlap center removeAutoMargin">
        ...
        <div class="w-100 mt-2" id="showprogress" style="display: none;">
            <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated" id="progresstinatie" style="width: 100%"
        ...
        <div class="col-auto col-md-10 col-sm-8">
            <div class="d-flex">
                <div class="buttonSync">
                    ...
                    <form id="ajaxform">
                        <button class="btn btn-primary save-data" data-toggle="tooltip" data-placement="right"
                            title="Dit kan enkele minuten duren...">Sync met Azure</button>
                    </form>
                </div>
                    ...
                    <tbody>
                        @foreach ($usersPaid as $user2)
                            <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                                ...
                                <td data-value="{{ $user2->id }}">
                                    <form method="get" action="/admin/leden/{{ $user2->id }}/groepen"><button
                                            class="btn btn-primary">Commissies</button></form>
                                </td>
                                <td data-value="{{ $user2->AzureID }}"><button type="button" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal1{{ $user2->AzureID }}"
                                        class="btn btn-danger">Verwijderen</button></td>
                            </tr>
                            <div class="modal fade" id="deleteModal1{{ $user2->AzureID }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <b>{{ $user2->FirstName . ' ' . $user2->LastName }}</b> wilt verwijderen?
                                        </div>
        ...
        <div class="col-auto col-md-10 col-sm-8">
            <h2>Niet betaald</h2>
            <a data-bs-toggle="modal" data-bs-target="#disableAllModal" class="btn-warning btn btnDelAcc">Verander
                account status voor alle niet betaalde leden</a>
                    ...
                    <tbody>
                        @foreach ($usersUnPaid as $user)
                            <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                                ...
                                <td data-value="{{ $user->commissie }}">
                                    <form method="get" action="/admin/leden/{{ $user->id }}/groepen"><button
                                            class="btn btn-primary">Commissies</button></form>
                                </td>
                                <td data-value="{{ $user->id }}"><a
                                        href="/admin/leden/{{ $user->id }}/permissions/"
                                        class="btn btn-primary">Rechten</a></td>
                                <td data-value="{{ $user->AzureID }}"><button type="button" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal{{ $user->AzureID }}"
                                        class="btn btn-danger">Verwijderen</button></td>
                                <td data-value="{{ $user->AzureID }}"><button type="button" data-bs-toggle="modal"
                                        data-bs-target="#disableModal{{ $user->AzureID }}"
                                        class="btn btn-secondary">Bijwerken</button></td>
                            </tr>
                            <div class="modal fade" id="deleteModal{{ $user->AzureID }}" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            Weet je zeker dat je de gebruiker
                                            <b>{{ $user->FirstName . ' ' . $user->LastName }}</b> wil verwijderen?
                                        </div>
                                        <div class="modal-footer">
                                            <form method="post" action="/admin/leden/delete">
                                                @csrf
                            ...
                            <div class="modal fade" id="disableModal{{ $user->AzureID }}" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Account van
                                                {{ $user->FirstName }}</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            Verander account status van
    ...
    <div class="modal fade" id="disableAllModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
