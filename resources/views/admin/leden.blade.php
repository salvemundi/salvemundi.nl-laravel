                ...
                <tbody>
                    @foreach ($usersPaid as $user2)
                        <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                            ...
                            <td data-value="{{ $user2->id }}"><form method="get" action="/admin/leden/{{$user2->id}}/groepen"><button class="btn btn-primary">Commissies</button></form></td>
                ...
                <tbody>
                    @foreach ($usersUnPaid as $user)
                        <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                            ...
                            <td data-value="{{ $user->commissie }}"><form method="get" action="/admin/leden/{{$user->id}}/groepen"><button class="btn btn-primary">Commissies</button></form></td>
