                        ...
                        @foreach ($whatsappLinks as $whatsappLink)
                            <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                                ...
                                <td data-value="{{ $whatsappLink->id }}">
                                    <form method="post" action="/admin/whatsappLinks/delete">@csrf<input type="hidden"
                                            name="id" value="{{ $whatsappLink->id }}"><button type="submit"
            ...
            <form method="POST" action="/admin/discord">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}"
                        value="{{ $discordLink->link ?? old('link') }}" id="link" name="link"
                        placeholder="Link...">
                </div>
                <div class="form-group py-3">
