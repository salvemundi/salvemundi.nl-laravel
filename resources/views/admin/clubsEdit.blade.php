            ...
            <form action="/admin/clubs/store" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control{{ $errors->has('clubName') ? ' is-invalid' : '' }}"
                        value="{{ $clubs->clubName }}" id="clubName" name="clubName" placeholder="Club naam...">
                </div>

                <div class="form-group">
                    <label for="voornaam">Bijnaam</label>
                    <input class="form-control{{ $errors->has('nickName') ? ' is-invalid' : '' }}"
                        value="{{ $clubs->nickName }}" id="nickName" name="nickName" placeholder="Bijnaam...">
                </div>

                <div class="form-group">
                    <label for="voornaam">Naam oprichter</label>
                    <input class="form-control{{ $errors->has('founderName') ? ' is-invalid' : '' }}"
                        value="{{ $clubs->founderName }}" id="founderName" name="founderName"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control{{ $errors->has('whatsappLink') ? ' is-invalid' : '' }}"
                        value="{{ $clubs->whatsappLink }}" id="whatsappLink" name="whatsappLink"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" value="{{ old('description') }}" type="textarea" id="description" name="description"
                        placeholder="Omschrijving...">{{ $clubs->description }}</textarea>
                </div>

                <div class="form-group">
                    <label for="voornaam">Discord link</label>
                    <input class="form-control{{ $errors->has('discordLink') ? ' is-invalid' : '' }}"
                        value="{{ $clubs->discordLink }}" id="discordLink" name="discordLink"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control{{ $errors->has('otherLink') ? ' is-invalid' : '' }}"
                        value="{{ $clubs->otherLink }}" id="otherLink" name="otherLink" placeholder="Andere link...">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="custom-file form-control">
                        <input style="border: hidden;" id="imgPath" name="imgPath" value="{{ $clubs->imgPath }}"
