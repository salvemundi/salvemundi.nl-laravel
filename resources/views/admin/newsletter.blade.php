                ...
                <tbody>
                    @foreach ($newsletter as $file)
                        <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                            ...
                            <td data-value="{{ $file->id }}"><form method="post" action="/admin/newsletter/delete">@csrf<input type="hidden" name="id" id="id" value="{{ $file->id }}"><button type="submit" class="btn btn-danger">Verwijderen</button></form></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
