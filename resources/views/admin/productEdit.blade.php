            ...
            <form action="/admin/products/edit/store" method="post">
                ...
                <div class="test">
                    ...
                    @if ($product->index != null)
                        <input readonly="readonly" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                ...
                <div class="test">
                    ...
                    <input class="form-control{{ $errors->has('reference') ? ' is-invalid' : '' }}"
                        value="{{ $product->amount }}" type="number" min="0" step=".01" id="price"
                ...
                <div class="test">
                    ...
                    <input class="form-control{{ $errors->has('reference') ? ' is-invalid' : '' }}"
                        value="{{ $product->redirect_url }}" type="text" min="0" step=".01" id="redirect_url"
                        name="redirect_url" placeholder="Redirect url...">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea type="textarea" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description"
                        placeholder="Beschrijving...">{{ $product->description }}</textarea>
                </div>
