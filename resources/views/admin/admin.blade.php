                            ...
                            <div class="row align-items-center gx-0">
                                <div class="col">
                                    <h6 class="text-uppercase text-muted mb-2">Aantal leden met lidmaatschap /
                                        totaal:</h6>
                                    <span class="h2 mb-0"><i style="display: flex" class="fas fa-users">
                                            <p class="dashboard-font">&nbsp;{{ $userCountPaid }} / {{ $userCount }}</p>
                                        </i></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center gx-0">
                                <div class="col">
                                    ...
                                    <span class="h2 mb-0"><i style="display: flex" class="fas fa-chart-pie">
                                            <p class="dashboard-font"> &nbsp;{{ $membersInCommittees }}</p>
                                        </i></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center gx-0">
                                <div class="col">
                                    <h6 class="text-uppercase text-muted mb-2">Aantal inschrijvingen in de afgelopen
                                        maand</h6>
                                    <span class="h2 mb-0"><i style="display: flex" class="fas fa-users">
                                            <p class="dashboard-font"> &nbsp;{{ $newMembersSinceLastMonth }}</p>
                                        </i></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center gx-0">
                                <div class="col">
                                    ...
                                    @foreach ($activities as $activity)
                                        @if ($activity->limit > 0)
                                            <span class="h2 mb-0">
                                                <h4 class="dashboard-font">{{ $activity->name }}:
                                                    {{ $activity->countSignups() }} / {{ $activity->limit }}</h4>
                                            </span>
                                        @else
                                            <span class="h2 mb-0">
                                                <h4 class="dashboard-font">{{ $activity->name }}:
                                                    {{ $activity->countSignups() }}</h4>
                                            </span>
                                        @endif
                                    @endforeach
                                </div>
