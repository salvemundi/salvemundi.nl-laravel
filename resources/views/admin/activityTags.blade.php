        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr id="tr-id-3" class="tr-class-2" data-title="bootstrap table">
                    ...
                    <td data-value="{{ $tag->id }}"><form method="post" action="/admin/activiteiten/tags/delete/{{$tag->id}}">@csrf<button type="submit" class="btn btn-danger">Verwijderen</button></form></td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div id="contact" class="col-md-6">
        ...
        <form action="/admin/activiteiten/tags/save" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" id="tagName" name="tagName" placeholder="Naam...">
            </div>
