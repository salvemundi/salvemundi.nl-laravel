        ...
        <div class="row">
            <div class="d-flex row col-md-10 col-lg-8 mx-auto">
                ...
                <p>
                    ...
                    Wil je zelf een club oprichten? Maak dan een draaiboek met deze <u><a
                            href="https://salvemundi.sharepoint.com/:w:/s/bestuur/EQWfBtpDCDpMmePkSBiAfHQBJXgsWGnxYOVmHXRHi7QufA">template</a></u>
                    en stuur het door naar <u><a href="mailto:bestruur@salvemundi.nl">bestuur@salvemundi.nl</a></u>.
                </p>
            </div>
            @if ($clubs !== null)
                            ...
                            <div class="row g-0 h-100">
                                @if ($club->imgPath != null)
                                    <div class="col-md-5 d-flex align-items-center">
                                        {!! '<img class="img-fluid rounded-start h-100 w-100" style="object-fit: cover;" src="/' .
                                            Thumbnailer::generate('storage/' . $club->imgPath, '80%') .
                                            '" />' !!}
                                    </div>
                                @endif
                                <div class="col-md-7">
                                                ...
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <a href="{{ $club->whatsappLink }}">
                                                            <button class="btn btn-primary mb-3"><i
                                                                    class="fab fa-whatsapp"></i> Join club</button>
                                                        </a>
                                                        <br>
                                                    </div>
                                                    @if ($club->discordLink)
