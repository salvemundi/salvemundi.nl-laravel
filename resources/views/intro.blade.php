        ...
        @else
            <div id="contact" class="col-md-6">
                ...
                <form action="/introData/store" method="post">
                    ...
                    <p>
                        Salvemundi organiseerd jaarlijks een introductieweek: De FHICT-introductie. Het is een week vol avontuur en teambuilding in Eindhoven. Zo leer je ook de stad beter kennen. Salve Mundi is druk bezig geweest om dit allemaal mogelijk te maken voor de nieuwe studenten. Er wordt rekening gehouden met verschillende scenario's en daarom is de kans dat de introductie dit jaar door gaat extra groot! Deze introductie vindt ook plaats van maandag 23 augustus tot en met vrijdag 27 augustus. Houd na het inschrijven je mail in de gaten voor updates, je zult later namelijk een mail ontvangen met daarin betalings details en aannvullende informatie!
                    </p>
                    <p>
