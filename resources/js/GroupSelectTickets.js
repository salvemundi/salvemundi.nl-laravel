window.generateTicketInputs = function (id, price) {
    const amountOfTickets = parseInt(document.getElementById("amountOfTickets"+id).value);
    ...
    for (let i = 0; i < amountOfTickets; i++) {
        ...
        document.getElementById('submitGroupTicketSignup' + id).textContent = "Inschrijven € " + newPrice
